...
registerLanguage('fr', 'Francais', '\u{1F1EB}\u{1F1F7}', {
    ...
    built: 'CONSTRUIT', build: 'Construire', theArena: 'L\'Arene',
    continueBattle: 'Continuer le Combat', yourZords: 'Vos Zords', goodbye: 'Au Revoir',
    trainZords: 'Entrainement Zords (Reponds aux Questions pour gagner de l\'XP!)',
    trainDesc: 'Reponds correctement a 5 questions pour gagner de l\'XP pour tous tes Zords. Cout : 5 rubis par session.',
    remove: 'Retirer', collect: 'Collecter !',
    runeYours: 'Correct ! La rune est a toi !',
    readyChallenge: 'Pret a tester tes competences en logique ? Entre dans le Mode Defi !',
    spaComplete: 'Spa Zord - Entrainement Termine !',
    notQuiteRight: 'Pas tout a fait juste.',
    gotIt: 'Compris ! On continue.',
    studyAnswer: 'Etudie la reponse, puis reessaye pour une deuxieme chance de capture !',
    classify: 'Classe cet enonce :', spotFallacy: 'Trouve le sophisme dans cet argument :',
    checkAnswers: 'Verifier les Reponses', matchFrom: 'Associer depuis :', matchTo: 'Associer avec :',
    clickToBuild: 'Clique sur les elements ci-dessous pour construire...',
    undo: 'Annuler', clear: 'Effacer', submit: 'Valider', testCircuit: 'Tester le Circuit',
    fightYourself: 'Te battre contre toi-meme', runAway: 'Fuir',
    allHealedUp: 'Voila ! Tous soignes !',
    tellAboutZords: 'Parle-moi des Zords',
    tellAboutIsland: 'Parle-moi de l\'ile',
    aimCast: 'Vise avec les fleches/WASD, Espace pour lancer !',
    noBite: 'Pas de touche... trop loin du remous. Appuie sur Espace pour reessayer.',
    nibbling: 'Quelque chose grignote...',
    fishBrokeFree: 'Le poisson s\'est libere au dernier moment ! Appuie sur Espace pour reessayer.',
    fishGotAway: 'Le poisson s\'est echappe ! Appuie sur Espace pour reessayer.',
    keepFishing: 'Continuer a Pecher', leave: 'Partir',
    casting: 'Lancer...', reeledIn: 'Ramene. Vise et lance a nouveau !',
    interactEnterHouse: '[E/Espace] Entrer dans la Maison',
    interactEnterStore: '[E/Espace] Entrer dans le Magasin',
    interactReadSign: '[E/Espace] Lire le Panneau',
    interactEnter: '[E/Espace] Entrer',
    interactFish: '[E/Espace] Pecher ici',
    interactArena: '[E/Espace] Entrer dans l\'Arene',
    interactHospital: '[E/Espace] Hopital Zord',
    interactSpa: '[E/Espace] Spa Zord',
    interactTalk: '[E/Espace] Parler a',
    interactBuild: '[E/Espace] Ouvrir le Menu de Construction',
    hpFull: 'PV pleins', noItems: 'Aucun objet',
    equipment: 'Equipement', buildingMaterials: 'Materiaux de Construction',
    why: 'Pourquoi ?',
    loc_cave: 'Les Cavernes', loc_town: 'Village Verdant', loc_forest: 'Bois Murmurante',
    loc_beach: 'Crique Corail', loc_mountains: 'Massif Pic de Fer', loc_zordarena: 'Colisee Zord',
    loc_island: 'Ile Mysterieuse', loc_peak_1: 'Contreforts Rocheux', loc_peak_2: 'Crete des Pins',
    loc_peak_3: 'Col Gele', loc_peak_4: 'Rocher Balaye par le Vent', loc_peak_5: 'Le Sommet',
    loc_temple_1: 'Salle de la Verite', loc_temple_2: 'Chambre de la Negation',
    loc_temple_3: 'La Grande Bibliotheque', loc_temple_4: 'Sanctuaire Gele',
    loc_temple_5: 'Labyrinthe de Lave', loc_temple_6: 'Le Vide Entre',
    loc_temple_7: 'Sanctuaire de l\'Archi-Logicien',
    sign_cave: 'Sortie vers Village Verdant -->',
    sign_town_left: '<-- Les Cavernes (ennemis !)',
    sign_town_right: 'Bois Murmurante -->',
    sign_town_north: 'Crique Corail ^',
    sign_town_south: 'v Massif Pic de Fer',
    sign_forest_left: '<-- Retour au Village',
    sign_forest_right: 'Temple de la Logique --> (Vaincs le Seigneur Logique d\'abord !)',
    sign_beach_south: 'Retour au Village v',
    sign_beach_dock: 'Quai de Peche - Lance ta ligne !',
    sign_mtn_north: 'Retour au Village ^',
    sign_mtn_deep: 'Attention ! De puissantes creatures habitent plus loin dans les pics.',
    sign_mtn_south: 'v L\'Ascension du Pic (5 niveaux jusqu\'au sommet !)',
    sign_peak: 'L\'air devient plus rare... continue a monter !',
    sign_beach_ferry: 'Ferry vers l\'Ile Mysterieuse ! Parle au Capitaine Finn.',
    sign_island_ferry: 'Ferry vers Crique Corail. Parle au Capitaine Finn.',
    sign_island: 'Bienvenue sur l\'Ile Mysterieuse ! De rares Zords y rodent.',
    sign_town_arena: 'Colisee Zord v (Combats, Soigne et Entraine !)',
    sign_arena_battle: 'L\'Arene - Combats les Dresseurs du Village !',
    sign_arena_hospital: 'Hopital Zord - Soigne tes Zords !',
    sign_arena_spa: 'Spa Zord - Entraine-toi et Monte de Niveau !',
    sign_arena_exit: 'Retour au Village v',
    sign_island_store: 'Frugalway - Epicerie de l\'Ile'
});
